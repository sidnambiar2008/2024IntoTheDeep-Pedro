...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(11.15, 6.793, 0);
        rightEncoderPose = new Pose(11.15, -6.793, 0);
        strafeEncoderPose = new Pose(1.125, -0.0875, Math.toRadians(90));
//  x = 11.15, x2 = 1.125
        hardwareMap = map;
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "left_front"));
